...
`
  ...
  l = e((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
      (e.SELF_EXPRESSION_PATTERNS =
        e.DIRECTED_PATTERNS =
        e.CONTEXT_SENSITIVE_EMOJIS =
        e.OFFENSIVE_EMOJI_SEQUENCES =
        e.OFFENSIVE_EMOJIS =
        e.CONTEXT_SENSITIVE =
        e.HARD_BLOCKED =
        e.ABBREVIATION_MAP =
      ...
      (e.HARD_BLOCKED =
        `viado.viadinho.viadao.sapatao.sapatona.traveco.travecos.travecas.baitola.boiola.bichona.putinha.putona.putaria.puta.putas.vagabunda.vagabundo.arrombado.arrombada.arrombadas.cuzao.cuzona.fdp.filho da puta.desgraca.desgracado.desgracada.retardado.retardada.mongoloid.mongoloide.vadia.quenga.rapariga.rameira.meretriz.vacilao.ppk.pqp.krl.gzr.bct.pnht.vsf.vtnc.tnc.pnc.fdse.crl.crh.btl.bqt.srrc.xvd.prnhb.phnta.buct.pnheta.pheta.bqut.mamad.gzd.gzada.sfada.nfsw.+18.phub.pornh.bronha.brnha.lisinha.brasileirinhas.punheteiro.punheteira.punheta.punhetao.punhetinha.punha.batendo uma.bora bater uma.gozando.anal.mamada.leitada.culinho.jogar um leite.esvaziar o saco.camera prive.deposito de porra.piranha.piranhas.interesseira.onlyf.se aliviou.ja se aliviou.bate uma.vou te mandar.te mandar uns videos.pelada.peladinha.peladona.nua.nuazinha.descabelar o palhaco.bater punheta.punhetar.siriricar.dedar.dedada.toque intimo.descarga.peitinho.teta.milf.gilf.pepeca.xibiu.grelo.brioco.toba.pedo.p3do.epstein.menininha.garotinha.bruna surfistinha.andressa urach.elisa sanches.mia linz.rita cadillac.vivi fernandes.fernanda campos.suzy cortez.mia khalifa.lana rhoades.riley reid.sasha grey.angela white.abella danger.adriana chechik.brandi love.asa akira.alexis texas.cam girl.fatal model.tits.fuck.jerk.jerk off.pussy.dick.cock.blowjob.estupro.estuprar.estuprador.estrupo.estrupador.pedofilo.pedofilia.zoofilia.necrofilia.pornografia infantil.nude.nudes.chupar pau.chupar pica.gozar.gozada.gozadas.foder.foda.fudendo.fudido.transar.transando.transa.piroca.pirocao.pirocas.pirocudo.buceta.bucetao.bucetas.bucetasso.bucetinha.bucetinhas.bucetonas.boceta.xoxota.xoxotas.xoxotinha.xereca.xexeca.xebreca.xerosa.xana.xaninha.xota.xotinha.xoroca.periquita.priquita.priquito.prexeca.prencheca.pitrica.checheca.chereca.brecheca.pechereca.xavasca.xabasca.chavasca.suruba.surubas.menage.menages.boquete.boquetes.boqueteira.boqueteiro.chupada.chupador.chupadora.chupando.chupou.encoxada.enrabadas.fornicada.trepada.trepadas.sirica.siririca.bilau.caralha.caralhudo.porra.merda.merdao.bosta.peitos.peituda.peitudas.tesuda.tesudas.tesudo.tezao.tezuda.tezudo.tarada.safada.safadas.safado.safados.rabuda.rabudas.gostozudas.greludas.piranhuda.piriguetes.dadeira.vou te matar.vou matar voce.se mata.se matar.vai se matar.suicida-se.macaco.macaca.crioulo.crioula.criolo.neguinho.neguinha.preto imundo.preta imunda.bola gato.feminazi.hipergamia.promiscua.rodada.gold digger.valor de mercado.gloriosa.manda nude.manda foto.quer transar.vamos transar.te pego.te como.pornhub.xvideos.xvidius.xnxx.redtube.youporn.tube8.spankbang.xhamster.beeg.tnaflix.sunporno.porntrex.hqporner.drtuber.eporner.motherless.fapdu.rule34.nhentai.hentaihaven.hanime.brazzers.realitykings.bangbros.mofos.fakehub.teamskeet.nubiles.onlyfans.fansly.manyvids.chaturbate.stripchat.bongacams.cam4.livejasmin.flirt4free.myfreecams.camsoda`.split(
          `.`
        )),
      (e.CONTEXT_SENSITIVE =
        `lixo.inutil.burro.burra.idiota.imbecil.nojento.nojenta.fracassado.fracassada.patetico.patetica.ridiculo.ridicula.covarde.fraco.fraca.perdedor.perdedora.otario.otaria.troxa.babaca.moleque.moleca.doente.maluco.maluca.taioba.escravo.escrava.submissa.submisso.mulher moderna.novinha.inocente.pequena.pau.rola.cacete.cu.pica.caralho.gostosa.gostoso.delicia`.split(
          `.`
        )),
      (e.OFFENSIVE_EMOJIS = [`🖕`, `🖕🏻`, `🖕🏼`, `🖕🏽`, `🖕🏾`, `🖕🏿`]),
      (e.OFFENSIVE_EMOJI_SEQUENCES = [
  ...
  u = e((e) => {
    ...
    function i(e) {
      ...
      return (
        ...
        (i = i.normalize(`NFC`)),
        (i = [...i].map((e) => n[e] ?? e).join(``)),
        (i = i.toLowerCase()),
        (i = i.normalize(`NFD`).replace(/[\u0300-\u036f\u0489]/g, ``)),
        (i = i.replace(/(.)\1+/g, `$1`)),
        (i = [...i].map((e) => r[e] ?? e).join(``)),
        (i = i.replace(/(\w)[.\-](?=\w[.\-])/g, `$1`)),
        (i = i.replace(/(\w)[.\-](\w)/g, `$1$2`)),
        (i = i.replace(/\b(\w)\s(\w)\s(\w)/g, (e, t, n, r) => t + n + r)),
        (i = i
          .split(/\s+/)
          .map((e) => t.ABBREVIATION_MAP[e] ?? e)
          .join(` `)),
        i
      );
    }
    function a(e, t, n) {
      let r = e.length,
        i = t.length;
      if (Math.abs(r - i) > n) return n + 1;
      let a = Array(i + 1);
      for (let e = 0; e <= i; e++) a[e] = e;
      for (let o = 1; o <= r; o++) {
        let r = Array(i + 1);
        r[0] = o;
        let s = o;
        for (let n = 1; n <= i; n++) {
          let i = e[o - 1] === t[n - 1] ? 0 : 1;
          ((r[n] = Math.min(a[n] + 1, r[n - 1] + 1, a[n - 1] + i)), r[n] < s && (s = r[n]));
        }
        if (s > n) return n + 1;
        a = r;
      }
    ...
    function c(e) {
      return e.map((e) => {
        let t = i(e),
          n = t.includes(` `) ? s(t) : `\\b${s(t)}\\b`;
        return { word: e, regex: new RegExp(n) };
      });
    }
    var u = /(?:\+?55\s?)?(?:\(?\d{2}\)?\s?)?\d{4,5}[\s.-]?\d{4}/,
      d = /https?:\/\/|www\.|\.com|\.net|\.org|\.br|\.io|\.me|\.tv|\.co|\.link|\.xyz/i;
    function f(e = {}) {
      let {
          extraBlockedWords: n = [],
          extraContextWords: r = [],
      ...
      for (let e of m) {
        let t = i(e);
        if (t.includes(` `) || t.length < 5 || y.has(t)) continue;
        y.add(t);
        let n = t.length;
        (v.has(n) || v.set(n, []), v.get(n).push(t));
      }
      return function (e) {
        let n = i(e);
        if (s && d.test(e)) return { allowed: !1, reason: `link`, matched: `link` };
        if (l && (u.test(e) || e.replace(/\D/g, ``).length >= 9))
          return { allowed: !1, reason: `phone`, matched: `telefone` };
        if (f && /^\d+$/.test(e.trim()))
          return { allowed: !1, reason: `digits_only`, matched: `numero isolado` };
        if (p) {
          let r = e.replace(/[\uFE00-\uFE0F\u200D]/g, ``);
          for (let e of t.OFFENSIVE_EMOJIS)
            if (r.includes(e)) return { allowed: !1, reason: `offensive_emoji`, matched: e };
          for (let e of t.OFFENSIVE_EMOJI_SEQUENCES)
            if (r.includes(e)) return { allowed: !1, reason: `offensive_emoji`, matched: e };
          for (let e of t.CONTEXT_SENSITIVE_EMOJIS)
            if (r.includes(e) && t.DIRECTED_PATTERNS.some((e) => e.test(n)))
              return { allowed: !1, reason: `offensive_emoji`, matched: e };
        }
        for (let { word: e, regex: t } of g)
          if (t.test(n)) return { allowed: !1, reason: `hard_block`, matched: e };
        {
          let e = new Set(n.split(/\s+/));
          for (let t of e) {
            let e = o(t.length);
            if (e !== 0)
              for (let n = t.length - e; n <= t.length + e; n++) {
                let r = v.get(n);
                if (r)
                  for (let n of r) {
                    let r = a(t, n, e);
                    if (r > 0 && r <= e) return { allowed: !1, reason: `fuzzy_match`, matched: n };
                  }
              }
          }
        }
        for (let { word: e, regex: r } of _)
          if (
            r.test(n) &&
            !t.SELF_EXPRESSION_PATTERNS.some((e) => e.test(n)) &&
            t.DIRECTED_PATTERNS.some((e) => e.test(n))
          )
            return { allowed: !1, reason: `directed_insult`, matched: e };
        return { allowed: !0 };
      };
    }
    e.filterContent = f();
  ...
  d = e((e) => {
    (Object.defineProperty(e, `__esModule`, { value: !0 }),
      (e.CONTEXT_SENSITIVE_EMOJIS =
        ...
        e.filterContent =
          void 0));
    var t = u();
    (Object.defineProperty(e, `filterContent`, {
      enumerable: !0,
      get: function () {
        return t.filterContent;
      },
    }),
      Object.defineProperty(e, `createFilter`, {
        enumerable: !0,
        get: function () {
          return t.createFilter;
        },
      }),
    ...
    var n = l();
    (Object.defineProperty(e, `HARD_BLOCKED`, {
      enumerable: !0,
      get: function () {
        return n.HARD_BLOCKED;
      },
    }),
      Object.defineProperty(e, `CONTEXT_SENSITIVE`, {
        enumerable: !0,
        get: function () {
          return n.CONTEXT_SENSITIVE;
        },
      }),
      Object.defineProperty(e, `DIRECTED_PATTERNS`, {
        enumerable: !0,
        get: function () {
          return n.DIRECTED_PATTERNS;
        },
      }),
      Object.defineProperty(e, `SELF_EXPRESSION_PATTERNS`, {
        enumerable: !0,
        get: function () {
          return n.SELF_EXPRESSION_PATTERNS;
        },
      }),
      Object.defineProperty(e, `ABBREVIATION_MAP`, {
        enumerable: !0,
        get: function () {
          return n.ABBREVIATION_MAP;
        },
      }),
      Object.defineProperty(e, `OFFENSIVE_EMOJIS`, {
        enumerable: !0,
        get: function () {
          return n.OFFENSIVE_EMOJIS;
        },
      }),
      Object.defineProperty(e, `OFFENSIVE_EMOJI_SEQUENCES`, {
        enumerable: !0,
        get: function () {
          return n.OFFENSIVE_EMOJI_SEQUENCES;
        },
      }),
      Object.defineProperty(e, `CONTEXT_SENSITIVE_EMOJIS`, {
        enumerable: !0,
        get: function () {
          return n.CONTEXT_SENSITIVE_EMOJIS;
        },
      }));
  }),
  f = n(),
    ...
    children: (0, g.jsxs)(`div`, {
      ...
      children: [
        (0, g.jsxs)(`a`, {
          href: `/`,
          className: `nav-brand`,
          children: [`Toxi`, (0, g.jsx)(`span`, { children: `BR` })],
        }),
        (0, g.jsxs)(`div`, {
          className: `nav-links`,
          children: [
            ...
            (0, g.jsx)(`a`, {
              href: `https://github.com/Diaum/toxibr/blob/main/CONTRIBUTING.md`,
              target: `_blank`,
              rel: `noopener`,
              children: `Contribuir`,
            }),
  ...
  return (0, g.jsxs)(`section`, {
    ...
    children: [
          ...
          (0, g.jsxs)(`span`, {
            ...
            children: [
              (0, g.jsx)(`svg`, {
                ...
                children: (0, g.jsx)(`path`, { d: `M13 2L3 14h9l-1 8 10-12h-9l1-8z` }),
              }),
              `v1.0`,
            ],
          }),
          (0, g.jsxs)(`span`, {
            className: `hero-badge pink`,
            children: [
              (0, g.jsxs)(`svg`, {
                width: `14`,
                height: `14`,
                ...
                strokeLinejoin: `round`,
                children: [
                  (0, g.jsx)(`path`, { d: `M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2` }),
                  (0, g.jsx)(`circle`, { cx: `9`, cy: `7`, r: `4` }),
                  (0, g.jsx)(`path`, { d: `M22 21v-2a4 4 0 0 0-3-3.87` }),
                  (0, g.jsx)(`path`, { d: `M16 3.13a4 4 0 0 1 0 7.75` }),
                ],
              }),
              `Open Source`,
            ],
          ...
          (0, g.jsxs)(`span`, {
            ...
            children: [
              (0, g.jsx)(`svg`, {
                ...
                strokeLinecap: `round`,
                strokeLinejoin: `round`,
                children: (0, g.jsx)(`polyline`, { points: `20 6 9 17 4 12` }),
              }),
              `Zero Deps`,
            ],
          }),
      ...
      (0, g.jsxs)(`h1`, {
        ...
        children: [
          (0, g.jsx)(`span`, { className: `hero-gradient`, children: `Moderacao de Chat` }),
          (0, g.jsx)(`br`, {}),
          `para o Portugues Brasileiro`,
        ],
      }),
      (0, g.jsxs)(`p`, {
        className: `hero-highlight`,
        children: [
          (0, g.jsx)(`span`, { className: `hl-accent`, children: `Context-Aware.` }),
          ` `,
          (0, g.jsx)(`span`, { className: `hl-green`, children: `Anti-Bypass.` }),
          ` `,
          (0, g.jsx)(`span`, { className: `hl-pink`, children: `< 1ms.` }),
        ],
      }),
      (0, g.jsx)(`p`, {
        className: `hero-desc`,
        children: `Filtro de conteudo toxico client-side com deteccao de leetspeak, homoglyphs e normalizacao Unicode. 300+ termos, 100% offline.`,
      }),
      (0, g.jsxs)(`div`, {
        ...
        children: [
          (0, g.jsxs)(`button`, {
            ...
            onClick: () => {
              (navigator.clipboard.writeText(`npm install toxibr`), e());
            },
            children: [
              (0, g.jsx)(`span`, { className: `install-prompt`, children: `$` }),
              `npm install toxibr`,
              (0, g.jsxs)(`svg`, {
      ...
      (0, g.jsxs)(`div`, {
        ...
        children: [
          (0, g.jsxs)(`div`, {
            ...
            children: [
              (0, g.jsx)(`span`, { className: `dot-red` }),
              (0, g.jsx)(`span`, { className: `dot-yellow` }),
              (0, g.jsx)(`span`, { className: `dot-green` }),
            ],
          }),
          (0, g.jsx)(`span`, { className: `terminal-title`, children: `toxibr — Terminal` }),
          (0, g.jsx)(`div`, {
            className: `terminal-bar-right`,
            children:
              e &&
              (0, g.jsxs)(g.Fragment, {
                children: [
                  (0, g.jsx)(`span`, { className: `terminal-tag`, children: `L33T` }),
                  (0, g.jsx)(`span`, { className: `terminal-tag`, children: `UTF` }),
                  (0, g.jsx)(`span`, {
                    className: `terminal-status-dot ${e.allowed ? `green` : `red`}`,
                  }),
                  (0, g.jsx)(`span`, {
      ...
      (0, g.jsxs)(`div`, {
        ...
        children: [
          (0, g.jsxs)(`div`, {
            className: `term-line`,
            children: [
              (0, g.jsx)(`span`, { className: `term-icon`, children: `■` }),
              (0, g.jsx)(`span`, {
                className: `term-white`,
                children: `ToxiBR Content Filter Engine`,
              }),
            ],
          }),
          (0, g.jsx)(`div`, { className: `term-spacer` }),
          e
            ? (0, g.jsxs)(g.Fragment, {
                children: [
                  (0, g.jsx)(`div`, {
                    ...
                    children: (0, g.jsx)(`span`, {
                      ...
                      children: `# ToxiBR Engine v1.0.0`,
                    }),
                  }),
                  (0, g.jsxs)(`div`, {
                    className: `term-line`,
                    children: [
                      (0, g.jsx)(`span`, { className: `term-prompt`, children: `$` }),
                      (0, g.jsx)(`span`, {
                        className: `term-white`,
                        children: `toxibr scan --lang=pt-br --obfuscation --leetspeak=moderate --unicode`,
                      }),
                    ],
                  }),
                  (0, g.jsx)(`div`, { className: `term-spacer` }),
                  (0, g.jsx)(`div`, {
                    ...
                    children: (0, g.jsxs)(`span`, {
                      className: `term-muted`,
                      children: [`# Input text (`, e.input.length, ` characters):`],
                    }),
                  }),
                  (0, g.jsx)(`div`, {
                    className: `term-line`,
                    children: (0, g.jsxs)(`span`, {
                      className: `term-accent`,
                      children: [`"`, e.input, `"`],
                    }),
                  }),
                  (0, g.jsx)(`div`, { className: `term-spacer` }),
                  ...
                  (0, g.jsx)(`div`, {
                    className: `term-line`,
                    children: (0, g.jsxs)(`span`, {
                      className: `term-purple`,
                      children: [`"`, e.normalized, `"`],
                    }),
                  }),
                  (0, g.jsx)(`div`, { className: `term-spacer` }),
                  (0, g.jsx)(`div`, {
                  ...
                  (0, g.jsxs)(`div`, {
                    className: `term-line`,
                    children: [
                      (0, g.jsx)(`span`, { className: `term-arrow`, children: `→` }),
                      (0, g.jsx)(`span`, { className: `term-muted`, children: `Status: ` }),
                      e.allowed
                        ? (0, g.jsx)(`span`, {
                            className: `term-result-badge allowed`,
                            children: `CONTENT CLEAN`,
                          })
                        : (0, g.jsx)(`span`, {
                            className: `term-result-badge blocked`,
                            children: `BLOCKED`,
                          }),
                    ],
                  }),
                    ...
                    (0, g.jsxs)(g.Fragment, {
                      children: [
                        (0, g.jsxs)(`div`, {
                          ...
                          children: [
                            (0, g.jsx)(`span`, { className: `term-arrow`, children: `→` }),
                            (0, g.jsx)(`span`, { className: `term-muted`, children: `Reason: ` }),
                            (0, g.jsx)(`span`, {
                              className: `term-yellow`,
                              children: y[e.reason] || e.reason,
                            }),
                          ],
                        }),
                        (0, g.jsxs)(`div`, {
                          ...
                          children: [
                            (0, g.jsx)(`span`, { className: `term-arrow`, children: `→` }),
                            (0, g.jsx)(`span`, { className: `term-muted`, children: `Matched: ` }),
                            (0, g.jsxs)(`span`, {
                              className: `term-red`,
                              children: [`"`, e.matched, `"`],
                            }),
                  ...
                  (0, g.jsxs)(`div`, {
                    ...
                    children: [
                      (0, g.jsx)(`span`, { className: `term-arrow`, children: `→` }),
                      (0, g.jsx)(`span`, { className: `term-muted`, children: `Time: ` }),
                      (0, g.jsxs)(`span`, {
                        className: `term-white`,
                        children: [e.time.toFixed(2), `ms`],
                      }),
                    ],
                  }),
                  (0, g.jsx)(`div`, { className: `term-spacer` }),
            ...
            : (0, g.jsxs)(g.Fragment, {
                children: [
                  ...
                  (0, g.jsx)(`div`, {
                    ...
                    children: (0, g.jsx)(`span`, {
                      className: `term-muted`,
                      children: `# Aguardando mensagem para analise...`,
                    }),
                  }),
                  (0, g.jsx)(`div`, { className: `term-spacer` }),
                  (0, g.jsxs)(`div`, {
                    ...
                    children: [
                      ...
                      (0, g.jsx)(`span`, {
                        className: `term-muted`,
                        children: `toxibr scan --awaiting-input`,
                      }),
                    ],
                  }),
                  (0, g.jsx)(`div`, { className: `term-spacer` }),
                  (0, g.jsx)(`div`, {
                    ...
                    children: (0, g.jsx)(`span`, {
                      className: `term-muted`,
                      children: `# Layers: hard_block, context_aware, phone, link, normalize`,
                    }),
                  }),
                  (0, g.jsxs)(`div`, {
                    className: `term-line`,
                    children: [
                      (0, g.jsx)(`span`, { className: `term-muted`, children: `# Status: ` }),
                      (0, g.jsx)(`span`, { className: `term-green`, children: `READY` }),
                    ],
                  }),
                  (0, g.jsx)(`div`, { className: `term-spacer` }),
                  (0, g.jsxs)(`div`, {
...
function x({ onScan: e, onReset: t }) {
  ...
  return (
    (window.__scannerSetText = (t) => {
      (r(t), e(t));
    }),
    (0, g.jsxs)(`div`, {
      className: `scanner`,
      children: [
        (0, g.jsx)(`h2`, { className: `scanner-title`, children: `Teste o Filtro` }),
        (0, g.jsx)(`p`, {
          className: `scanner-desc`,
          children: `Digite ou cole conteudo e escaneie com um clique.`,
        }),
        (0, g.jsxs)(`div`, {
          className: `scanner-input-wrapper`,
          children: [
            (0, g.jsx)(`textarea`, {
              ref: i,
            ...
            (0, g.jsxs)(`span`, { className: `scanner-count`, children: [n.length, `/3000`] }),
          ],
        }),
        (0, g.jsxs)(`div`, {
            ...
            (0, g.jsxs)(`button`, {
              ...
              children: [
                (0, g.jsxs)(`svg`, {
                  ...
                  strokeLinejoin: `round`,
                  children: [
                    (0, g.jsx)(`circle`, { cx: `11`, cy: `11`, r: `8` }),
                    (0, g.jsx)(`path`, { d: `m21 21-4.3-4.3` }),
                  ],
                }),
                `Scan`,
              ],
            ...
            (0, g.jsxs)(`button`, {
              ...
              children: [
                (0, g.jsxs)(`svg`, {
                  ...
                  strokeLinejoin: `round`,
                  children: [
                    (0, g.jsx)(`path`, { d: `M3 12a9 9 0 0 1 9-9 9.75 9.75 0 0 1 6.74 2.74L21 8` }),
                    (0, g.jsx)(`path`, { d: `M21 3v5h-5` }),
                    (0, g.jsx)(`path`, {
                      d: `M21 12a9 9 0 0 1-9 9 9.75 9.75 0 0 1-6.74-2.74L3 16`,
                    }),
                    (0, g.jsx)(`path`, { d: `M3 21v-5h5` }),
                  ],
                }),
                `Reset`,
              ],
...
var ee = [
  { text: `eu me sinto um lixo`, type: `safe` },
  { text: `voce e um lixo`, type: `toxic` },
  { text: `3stupr0`, type: `bypass` },
  { text: `meu computador travou`, type: `safe` },
  { text: `p.u.t.a`, type: `bypass` },
  { text: `sua gostosa`, type: `toxic` },
  { text: `comida gostosa`, type: `safe` },
  { text: `(21) 99470-9426`, type: `toxic` },
  { text: `vi​ado`, label: `vi​ado (zero-width)`, type: `bypass` },
  { text: `preciso de ajuda`, type: `safe` },
  { text: `ppk`, type: `bypass` },
  { text: `pau de selfie`, type: `safe` },
];
function S({ onSelect: e }) {
  let t = (t) => {
    let n = window.__scannerSetText;
    n ? n(t) : e(t);
  };
  return (0, g.jsx)(`section`, {
    className: `examples-section`,
    children: (0, g.jsxs)(`div`, {
      className: `examples-inner`,
      children: [
        (0, g.jsx)(`h3`, { className: `examples-title`, children: `Exemplos para testar` }),
        (0, g.jsx)(`div`, {
          ...
          children: ee.map((e, n) =>
            (0, g.jsxs)(
              `button`,
              {
                ...
                onClick: () => t(e.text),
                children: [
                  (0, g.jsx)(`span`, { className: `example-dot ${e.type}` }),
                  (0, g.jsx)(`span`, { className: `example-text`, children: e.label || e.text }),
                ],
              },
              n
            )
...
function C({ hardBlocked: e, contextSensitive: t }) {
  return (0, g.jsx)(`section`, {
    ...
    children: (0, g.jsxs)(`div`, {
      ...
      children: [
        (0, g.jsxs)(`div`, {
          className: `stat-card`,
          children: [
            (0, g.jsx)(`div`, { className: `stat-value accent`, children: e }),
            (0, g.jsx)(`div`, { className: `stat-label`, children: `Termos bloqueados` }),
          ],
        }),
        (0, g.jsxs)(`div`, {
          className: `stat-card`,
          children: [
            (0, g.jsx)(`div`, { className: `stat-value purple`, children: t }),
            (0, g.jsx)(`div`, { className: `stat-label`, children: `Context-sensitive` }),
          ],
        }),
        (0, g.jsxs)(`div`, {
          className: `stat-card`,
          children: [
            (0, g.jsx)(`div`, { className: `stat-value green`, children: `< 1ms` }),
            (0, g.jsx)(`div`, { className: `stat-label`, children: `Por mensagem` }),
          ],
        }),
        (0, g.jsxs)(`div`, {
          className: `stat-card`,
          children: [
            (0, g.jsx)(`div`, { className: `stat-value pink`, children: `100%` }),
            (0, g.jsx)(`div`, { className: `stat-label`, children: `Offline / Client-side` }),
          ],
        }),
      ],
    }),
...
function ne({ visible: e }) {
  return (0, g.jsx)(`div`, { className: `toast ${e ? `show` : ``}`, children: `Copiado!` });
}
function re() {
  let [e, t] = (0, f.useState)(null),
    ...
    i = (0, f.useCallback)((e) => {
      ...
      let n = performance.now(),
        r = (0, m.filterContent)(e),
        i = performance.now() - n;
      t({
        input: e,
        normalized: (0, m.normalize)(e),
        allowed: r.allowed,
        reason: r.allowed ? void 0 : r.reason,
        matched: r.allowed ? void 0 : r.matched,
        time: i,
      });
    }, []),
    a = (0, f.useCallback)(() => {
  ...
  return (0, g.jsxs)(g.Fragment, {
    children: [
      (0, g.jsx)(`div`, { className: `glow-orb` }),
      (0, g.jsx)(_, {}),
      (0, g.jsx)(v, { onCopy: a }),
      (0, g.jsx)(`section`, {
        ...
        children: (0, g.jsxs)(`div`, {
          ...
          children: [
            (0, g.jsx)(b, { result: e }),
            (0, g.jsx)(x, { onScan: i, onReset: () => t(null) }),
          ],
        }),
      }),
      (0, g.jsx)(S, { onSelect: i }),
      (0, g.jsx)(C, {
        hardBlocked: m.HARD_BLOCKED.length,
        contextSensitive: m.CONTEXT_SENSITIVE.length,
      }),
      (0, g.jsx)(te, {}),
      (0, g.jsx)(ne, { visible: n }),
    ],
  });
}
(0, p.createRoot)(document.getElementById(`root`)).render(
  (0, g.jsx)(f.StrictMode, { children: (0, g.jsx)(re, {}) })
);
